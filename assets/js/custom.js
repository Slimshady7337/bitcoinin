const main = () => {
  ...
  const EVENTDATE = new Date("January 17, 2024, 19:00:00");
    ...
    $(".collapse")
      .on("show.bs.collapse", function () {
        ...
        $(this).closest(".card").css({
          ...
          background:
            "linear-gradient(135deg, #F2B253 0%, #E0724A 53.25%, #E56756 100%)",
        });
        $(this).css("transition", "height 700ms ease");
      })
...
$(document).ready(function () {
  $(".menu ul li a,.monkey_footer a,.header_btn  a, .tokenomics_scroll").click(
    function () {
      $("html,body").animate(
        {
